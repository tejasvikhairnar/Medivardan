...
export default function NewPatientReportPage() {
  ...
  // Mock Data
  const reportData = [
    { srNo: 1, patientNo: "P114021", name: "Kanara Chaudhari", mobile: "9969361250", date: "24-Dec-2025", clinic: "Karve Road" },
    { srNo: 2, patientNo: "P114020", name: "Naresh Palkar", mobile: "8380020865", date: "24-Dec-2025", clinic: "Karve Road" },
    { srNo: 3, patientNo: "P114019", name: "Kuldeep Modanwal", mobile: "9284793237", date: "24-Dec-2025", clinic: "Karve Road" },
  ]
  ...
  return (
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-center gap-2 text-primary mb-8 border-b border-border pb-4">
        ...
        <h1 className="text-xl font-bold tracking-tight text-medivardaan-teal uppercase">New Patient Report</h1>
      </div>
